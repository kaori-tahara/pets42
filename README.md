...
- 詳細表示画面からユーザーのマイページへ遷移でき、どのようなユーザーかを確認できます。
- ユーザーはマイページを一つ作ることができ、犬好きであることや自分のことをアピールすることができます。

# GIF

# 実装予定の機能
- ユーザーの設定とマイページにコメント機能をつけ評価を得られるようにします。
- mailと紐づいていないので、依頼もしくは申し込みをしたらユーザーの登録しているメールアドレスへ依頼または申し込みが来たことを知らせる設定まで実施したいです。その後の細かいやりとりはメールを介してできるように設定します。
